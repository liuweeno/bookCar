      ...
      <div class="setting" @click.stop="">
        <div class="set-wrap">
          ...
          <div class="select">
            ...
            <span
              class="switch"
              @click="setStore.tagViewsShow = !setStore.tagViewsShow"
              :class="{ sl: setStore.tagViewsShow }"
            >
          ...
          <div class="select">
            ...
            <span
              class="switch"
              :class="{ sl: setStore.siderLogoShow }"
              @click="setStore.siderLogoShow = !setStore.siderLogoShow"
            >
              <span class="traball"></span>
              <span class="swball"></span>
            </span>
...
.setfade-enter-active,
.setfade-leave-active {
...
.setfade-enter-active .setting,
.setfade-leave-active .setting {
  transition:
    transform 0.5s,
    opacity 0.5s;
}
.setfade-enter-from .setting,
.setfade-leave-to .setting {
